<?php /*a:4:{s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/binding/qq.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;s:62:"/www/wwwroot/guang.ailiutang.cn/app/view/public/copyright.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="layui-card-body" pad15>
					<div class="layui-form form-label-w8" lay-filter="" style="margin-top:20px">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline" style="width:340px">
								<input type="text" name="info[apptoken]" value="<?php echo $info['apptoken']; ?>" class="layui-input">
								<?php if($info['apptoken']): ?><div style="position: absolute;left: 0;top: 0;right: 0;bottom: 0; background: #fff;padding: .35rem .7rem;border: 1px solid rgba(0, 0, 0, .15);border-radius: .15rem;color: #636c72;" onclick="$(this).hide()">已隐藏内容，点击查看或编辑</div><?php endif; ?>
							</div>
							<div class="layui-form-mid layui-word-aux"></div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="info[wxpay_appid]" value="<?php echo $info['wxpay_appid']; ?>" class="layui-input"/>
							</div>
						...
						<div class="layui-form-item" id="wxpay_type1set" <?php if($info['wxpay_type']==0): ?>style="display:none"<?php endif; ?>>
						...
						<div id="wxpay_type0set" <?php if($info['wxpay_type']==1): ?>style="display:none"<?php endif; ?>>
							<div class="layui-form-item">
								<label class="layui-form-label">支付商户号：</label>
								<div class="layui-input-inline">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline" style="width:450px">
									<input style="float:left;" readonly="readonly" class="layui-input" type="text" name="info[wxpay_apiclient_key]" value="<?php echo $info['wxpay_apiclient_key']; ?>" id="wxpay_apiclient_key"/>
								</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-form-mid"><?php echo app('request')->domain(); ?>/notify.php</div>
						</div>
						<div class="layui-form-item">
...
<script>
	...
	function downloadxcx(){
		...
		//	layer.close(index);
			...
			layui.form.on('submit(submit_downloadxcx)', function(obj){
				var field = obj.field;
				var index = layer.load();
				$.post("<?php echo url('downloadqqxcx'); ?>",field,function(data){
					layer.close(index);
	...
	layui.form.on('submit(submit_reg)', function(obj){
		...
		$.post('',field,function(data){
			dialog(data.msg,data.status,'<?php echo url('qq'); ?>');
		})
	});
  </script>
