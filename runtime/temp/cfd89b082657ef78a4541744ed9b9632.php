<?php /*a:4:{s:64:"/www/wwwroot/guang.ailiutang.cn/app/view/binding/sdbangding.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;s:62:"/www/wwwroot/guang.ailiutang.cn/app/view/public/copyright.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="layui-card-body" pad15>
					<div class="layui-form form-label-w10" lay-filter="" style="margin-top:20px">
						...
						<div class="layui-form-item" style="margin-bottom:0">
							...
							<div class="layui-form-mid" style="width:200px;font-weight:bold"><?php echo PRE_URL2; ?></div>
							<div class="layui-form-mid layui-word-aux"></div>
						</div>
						<div class="layui-form-item" style="margin-bottom:0">
							<label class="layui-form-label">socket合法域名：</label>
							<div class="layui-form-mid" style="width:200px;font-weight:bold">wss://<?php echo str_replace('https://','',PRE_URL2); ?></div>
							<div class="layui-form-mid layui-word-aux"></div>
						</div>
						<div class="layui-form-item" style="margin-bottom:0">
						...
						<div class="layui-form-item">
							...
							<div class="layui-form-mid layui-word-aux" style="margin-left:10px"> 下载后解压压缩包得到 <span style="color:green;font-weight:bold">wx_<?php echo $set['aid']; ?></span> 文件夹</div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-form-mid">打开开发者工具，依次选择[小程序]-[+]-[导入项目]-[目录]，选择第三步解压得到的文件夹“wx_<?php echo $set['aid']; ?>”，点击右下角[导入]按钮</div>
						</div>
						<div class="layui-form-item">
