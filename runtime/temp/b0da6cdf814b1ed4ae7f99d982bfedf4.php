<?php /*a:3:{s:62:"/www/wwwroot/guang.ailiutang.cn/app/view/web_system/index.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>控制台-<?php echo $webinfo['webname']; ?></title>
...
<link rel="stylesheet" type="text/css" href="/static/fonts/iconfont.css?v=20201218" media="all">
  <base target="mainFrame" />
	...
	.menu-header{line-height: 50px;height:50px;/*border-top: 1px solid #f7f7f8;*/cursor: pointer;padding-left: 5px;}
	.menu-icon{width: 20px;height: 50px;float: left;text-align: center;font-size: 8px;color: #666;line-height: 50px;}

	.wb-subnav .subnav-scene {overflow: hidden;height: 78px;line-height: 78px;padding-left: 20px;}
	.wb-subnav ul li {height: 50px;line-height: 50px;font-size: 12px;}
	.wb-subnav ul li a {color: #7c838a;}
	.wb-subnav ul.single {display: block;}
	.wb-subnav ul.single li a {padding-left: 20px;color: #666;}
	.menu-header:hover{background: #f5f5f5;}
	.menu-header.data-active:not(.active){background: #f5f5f5;}
	.menu-header.point{position: relative;}
	.menu-header.point:after{position: absolute;content: '';width:4px;height:4px;border-radius: 50%;left:77px;top:20px;border:2px solid red;}
	.wb-subnav ul li.active, .wb-subnav ul li:hover {background: #edf6ff;}

	.threemenu.point{position: relative;}
	.threemenu.point:after{position: absolute;content: '';width:4px;height:4px;border-radius: 50%;left:100px;top:20px;border:2px solid red;}
	.wb-subnav ul li.active a {color: #00aeff;}
	.wb-subnav .wb-subnav-fold {position: absolute;width: 17px;height: 34px;background: #f5f7f9;top: 20px;left: 93px;line-height: 34px;color: #b1bfcb;border: 1px solid #efefef;border-right: none;cursor: pointer;text-align:center}
    ...
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:void(0)" onclick="fullScreen()" title="全屏">
              <img src="/static/admin/img/fullscreen.png" style="width:16px">
            </a>
          </li>
          <li class="layui-nav-item" lay-unselect>
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          <li class="layui-nav-item" lay-unselect title="客户端">
            <a href="javascript:void(0)" onclick="window.parent.location.href='<?php echo url('WebUser/alogin'); ?>/uid/<?php echo session('BST_ID'); ?>'" lay-text="客户端">
              <!-- <i class="layui-icon layui-icon-website"></i> --> 返回客户端
            </a>
          </li>
          <li class="layui-nav-item layui-hide-xs" lay-unselect>
            <a href="javascript:;" onclick="theme()">
              <i class="layui-icon layui-icon-theme"></i>
            </a>
          </li>
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              <cite><?php echo session('ADMIN_NAME'); ?></cite>
            </a>
          ...
          <li class="layui-nav-item layui-hide-xs" lay-unselect>
            <a href="javascript:;" onclick="about()"><i class="layui-icon layui-icon-more-vertical"></i></a>
          </li>
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
            <?php if((!getcustom('admin_user_hide'))): ?>
            <a href="<?php echo url('WebUser/index'); ?>/type/1">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li class="layui-nav-item">
              <?php if($menu['child']): ?>
                <a href="javascript:;" lay-tips="<?php echo $menu['name']; ?>" lay-direction="2" style="padding-right:0;<?php if(!$menu['icon']): ?>padding-left:20px<?php endif; ?>" onclick="showsubnav('<?php echo $k; ?>')">
        ...
        <div class="wb-subnav" style="display:none">
            <div style="width: 100%;height: 100%;overflow-y: auto">
                ...
                <div id="subnav_<?php echo $k; ?>" style="display:none">
                    ...
                    <?php foreach($menu['child'] as $menu2): if($menu2 && isset($menu2['child'])): ?>
                        <div class="menu-header" style="font-size:13px"><div class="menu-icon fa fa-caret-right"></div><?php echo $menu2['name']; ?></div>
                        <ul style="">
                        <?php foreach($menu2['child'] as $menu3): ?>
                        <li><a href="<?php echo url($menu3['path']); ?>"><?php echo $menu3['name']; ?></a></li>
                        <?php endforeach; ?>
                        </ul>
                        <?php else: ?>
                        <ul class="single">
                            <li style="position: relative"><a href="<?php echo url($menu2['path']); ?>" style="cursor: pointer;color:#333;font-size:13px"><?php echo $menu2['name']; ?></a></li>
                        </ul>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
            <?php if((!getcustom('admin_user_hide'))): ?>
            <iframe src="<?php echo url('WebUser/index'); ?>/type/1" frameborder="0" class="layadmin-iframe" id="mainFrame" name="mainFrame"></iframe>
            <?php else: ?>
            <iframe src="<?php echo url('WebSystem/set'); ?>/type/1" frameborder="0" class="layadmin-iframe" id="mainFrame" name="mainFrame"></iframe>
            <?php endif; ?>
        </div>
      </div>
      <!-- 辅助元素，一般用于移动设备下遮罩 -->
...
<script>
	...
	function about(){
		...
		html+='	<p>当前版本：v<?php echo $myversion; ?></p>';
		html+='</div>';
		html+='<div class="layui-card-body layui-text layadmin-about">';
