<?php /*a:3:{s:73:"/www/wwwroot/guang.ailiutang.cn/app/view/designer_page/choosezuobiao.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="layui-card-body" pad15>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width:500px">
					<input type="text" id="address" lay-verify="required" lay-verType="tips" class="layui-input" value="<?php echo app('request')->param('address'); ?>">
				</div>
			...
			<div class="layui-form-item" style="margin-bottom:0">
				...
				<div style="margin-left:110px">
					<input type="hidden" id="mapjd" value="<?php if(input('param.jd')): ?><?php echo app('request')->param('jd'); else: ?>116.397827<?php endif; ?>"/>
					<input type="hidden" id="mapwd" value="<?php if(input('param.wd')): ?><?php echo app('request')->param('wd'); else: ?>39.90374<?php endif; ?>"/>
				</div>
			</div>
          </div>
        </div>
...
<script>
	...
	function searchMap(address) {
		$.post("<?php echo url('searchFormMap'); ?>", {keywords:address,lat:wd,lng:jd},function(results){
			if(results.status == 1) {
