<?php /*a:4:{s:59:"/www/wwwroot/guang.ailiutang.cn/app/view/binding/baidu.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;s:62:"/www/wwwroot/guang.ailiutang.cn/app/view/public/copyright.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="layui-card-body" pad15>
					<div class="layui-form form-label-w8" lay-filter="" style="margin-top:20px">
						<div class="layui-form-item">
							...
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[基础设置]-[开发设置]中查找</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">App Key：</label>
							<div class="layui-input-inline" style="width:320px">
								<input type="text" name="info[appkey]" value="<?php echo $info['appkey']; ?>" class="layui-input">
								<?php if($info['appkey']): ?><div style="position: absolute;left: 0;top: 0;right: 0;bottom: 0; background: #fff;padding: .35rem .7rem;border: 1px solid rgba(0, 0, 0, .15);border-radius: .15rem;color: #636c72;" onclick="$(this).hide()">已隐藏内容，点击查看或编辑</div><?php endif; ?>
							</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[基础设置]-[开发设置]中查找</div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="radio" name="info[baidupay]" title="开启" value="1" <?php if($info['baidupay']==1): ?>checked<?php endif; ?>/>
								<input type="radio" name="info[baidupay]" title="关闭" value="0" <?php if($info['baidupay']==0): ?>checked<?php endif; ?>/>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">APP ID：</label>
							<div class="layui-input-inline" style="width:280px">
								<input type="text" name="info[pay_appid]" value="<?php echo $info['pay_appid']; ?>" class="layui-input">
							</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[功能管理]-[支付设置]中查找</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">APP KEY：</label>
							<div class="layui-input-inline" style="width:280px">
								<input type="text" name="info[pay_appkey]" value="<?php echo $info['pay_appkey']; ?>" class="layui-input">
							</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[功能管理]-[支付设置]中查找</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">dealId：</label>
							<div class="layui-input-inline" style="width:280px">
								<input type="text" name="info[pay_dealId]" value="<?php echo $info['pay_dealId']; ?>" class="layui-input">
							</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[功能管理]-[支付设置]中查找</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline" style="width:500px">
								<input type="text" name="info[pay_publickey]" value="<?php echo $info['pay_publickey']; ?>" class="layui-input">
								<?php if($info['appsecret']): ?><div style="position: absolute;left: 0;top: 0;right: 0;bottom: 0; background: #fff;padding: .35rem .7rem;border: 1px solid rgba(0, 0, 0, .15);border-radius: .15rem;color: #636c72;" onclick="$(this).hide()">已隐藏内容，点击查看或编辑</div><?php endif; ?>
							</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[功能管理]-[支付设置]中查找</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline" style="width:500px">
								<input type="text" name="info[pay_privatekey]" value="<?php echo $info['pay_privatekey']; ?>" class="layui-input">
								<?php if($info['appsecret']): ?><div style="position: absolute;left: 0;top: 0;right: 0;bottom: 0; background: #fff;padding: .35rem .7rem;border: 1px solid rgba(0, 0, 0, .15);border-radius: .15rem;color: #636c72;" onclick="$(this).hide()">已隐藏内容，点击查看或编辑</div><?php endif; ?>
							</div>
							<div class="layui-form-mid layui-word-aux">请填写RSA私钥，一行字符串<a href="https://smartprogram.baidu.com/" target="_blank">点击查看生成方法</a></div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">支付回调地址：</label>
							<div class="layui-form-mid"><?php echo PRE_URL2; ?>/notify.php</div>
							<div class="layui-form-mid layui-word-aux">登录<a href="https://smartprogram.baidu.com/" target="_blank">百度小程序平台</a>[管理]-[功能管理]-[支付设置]-[支付开发设置]中编辑</div>
						</div>
						<div class="layui-form-item">
...
<script>
	...
	function downloadxcx(){
		layer.confirm('下载代码包用开发者工具进行上传代码，确定要下载吗?',function(index){
			...
			layui.form.on('submit(submit_downloadxcx)', function(obj){
				var field = obj.field;
				var index = layer.load();
				$.post("<?php echo url('downloadbaiduxcx'); ?>",field,function(data){
					layer.close(index);
	...
	layui.form.on('submit(submit_reg)', function(obj){
		...
		$.post('',field,function(data){
			dialog(data.msg,data.status,'<?php echo url('baidu'); ?>');
		})
	})
	layui.upload.render({
