<?php /*a:3:{s:60:"/www/wwwroot/guang.ailiutang.cn/app/view/backstage/plog.html";i:1762426633;s:56:"/www/wwwroot/guang.ailiutang.cn/app/view/public/css.html";i:1762426633;s:55:"/www/wwwroot/guang.ailiutang.cn/app/view/public/js.html";i:1762426633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card layui-col-md12">
          <div class="layui-card-header">
						...
						<?php if($_GET['isopen']==1): ?><i class="layui-icon layui-icon-close" style="font-size:18px;font-weight:bold;cursor:pointer" onclick="closeself()"></i><?php endif; ?>
					</div>
          <div class="layui-card-body" pad15>
						...
						<div class="layui-form layui-form-search layui-col-md6">
							...
							<div class="layui-inline layuiadmin-input-useradmin">
								...
								<div class="layui-input-inline">
									<input type="text" name="remark" autocomplete="off" class="layui-input" value="<?php echo input('get.remark'); ?>">
								</div>
							</div>
							<div class="layui-inline">
...
<script>
  ...
  var tableIns = table.render({
    ...
    ,cols: [[ //表头
      ...
      {field: 'un', title: '账号'},
      {field: 'createtime', title: '操作时间',templet:function(d){ return date('Y-m-d H:i',d.createtime)}},
      {field: 'remark', title: '操作内容'},
		  {field: 'ip', title: 'IP',width:150},
			{field: 'operation', title: '操作',templet: '<div><button class="table-btn" onclick="datadel({{d.id}})">删除</button></div>',width:100}
    ]]
  });
	//排序
	...
	function datadel(id){
		...
		layer.confirm('确定要删除吗？删除后无法恢复！',{icon: 7, title:'操作确认'}, function(index){
			...
			layer.close(index);
			var index = layer.load();
			$.post("<?php echo url('plog'); ?>",{op:'del',ids:ids},function(data){
				layer.close(index);
