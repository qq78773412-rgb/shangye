	...
	<block v-if="isload">
		...
		<view class="order-content">
			<block v-for="(item, index) in datalist" :key="index">
                ...
                <block v-else>
                  <view>
                    <view v-if="item.count<item.kccount"  @tap.stop="goto" :data-url="'product?id=' + item.kcid" class="btn2" style="margin-top: 10rpx;">继续学习</view>
                    <view v-if="item.iskaoshi==1" @tap.stop="goto" :data-url="'recordlog?kcid=' + item.kcid" class="btn2" style="margin-top: 10rpx;">答题记录</view>
                  </view>
								</block>
							</view>
						</view>
