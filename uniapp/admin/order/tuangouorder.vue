	...
	<block v-if="isload">
		...
		<view class="order-content">
			<block v-for="(item, index) in datalist" :key="index">
				<view class="order-box" @tap="goto" :data-url="'tuangouorderdetail?id=' + item.id">
					<view class="head">
					...
					<view class="content" style="border-bottom:none">
						<view @tap="goto" :data-url="'/activity/tuangou/product?id=' + item.proid">
  ...
  methods: {
    getdata: function (loadmore) {
      ...
      var st = that.st;
			...
			that.nomore = false;
			that.loading = true;
      app.post('ApiAdminOrder/tuangouorder', {keyword:that.keyword,st: st,pagenum: pagenum}, function (res) {
				that.loading = false;
