...
export default {
  ...
  methods: {
		getdata:function(){
			var that = this;
			that.loading = true;
			app.get("ApiYuyueWorker/login", {}, function (res) {
				that.loading = false;
				that.loaded();
			});
		},
    formSubmit: function (e) {
      ...
      if (formdata.username == ''){
        ...
        return;
			...
			app.showLoading('提交中');
      app.post("ApiYuyueWorker/login", {username:formdata.username,password:formdata.password,captcha:formdata.captcha}, function (res) {
