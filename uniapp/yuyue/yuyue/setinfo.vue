...
export default {
  ...
  methods: {
		getdata: function () {
			var that = this;
			that.loading = true;
			app.get('ApiYuyueWorker/set', {}, function (data) {
				that.loading = false;
    ...
    formSubmit: function (e) {
      ...
      if (bankname == '') {
        app.alert('请选择开户行');return;
			...
			app.showLoading('提交中');
      app.post("ApiYuyueWorker/set", {bankname:bankname,bankcarduser:bankcarduser,bankcardnum:bankcardnum,weixin:weixin,aliaccount:aliaccount,code:code}, function (data) {
